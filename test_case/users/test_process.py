...
'''
自动生成 数字 20,80   #生成20到80之间的数字 例：56s
...
#   注册
@pytest.mark.nba
def test_klob_sign(pub_data):
    pub_data["username"] = "自动生成 字符串 5 数字 xj"
...
def test_getAccInfo(pub_data):
    ...
    headers = {'Host': 'qa.yansl.com:8084', 'Connection': 'keep-alive', 'accept': '*/*', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/537.36', 'Referer': 'http://qa.yansl.com:8084/swagger-ui.html?urls.primaryName=user%20apis', 'Accept-Encoding': 'gzip, deflate', 'Accept-Language': 'zh-CN,zh;q=0.9'}
    status_code = 200  # 响应状态码
    expect = "2000"  # 预期结果
